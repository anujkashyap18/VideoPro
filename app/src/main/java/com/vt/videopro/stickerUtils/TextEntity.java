package com.vt.videopro.stickerUtils;
...
public class TextEntity extends MotionEntity {
	...
	public TextEntity ( @NonNull TextLayer textLayer , @IntRange ( from = 1 ) int canvasWidth , @IntRange ( from = 1 ) int canvasHeight , @NonNull FontProvider fontProvider ) {
	...
	private Bitmap createBitmap ( @NonNull TextLayer textLayer , @Nullable Bitmap reuseBmp ) {
		...
		StaticLayout sl = new StaticLayout ( textLayer.getText ( ) , // - text which will be drawn
				textPaint , boundsWidth , // - width of the layout
